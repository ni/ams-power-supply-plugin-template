...
AddOutputFilter chunkFilter
		...
		<Item Name="gRPC" Type="Folder">
			...
			<Item Name="Custom" Type="Folder">
				<Item Name="BLSPowerSupplyTemplateService_client.lvlib" Type="Library" URL="../Plugin/Custom gRPC/BLSPowerSupplyTemplateService_client/BLSPowerSupplyTemplateService_client.lvlib"/>
				<Item Name="BLSPowerSupplyTemplateService_server.lvlib" Type="Library" URL="../Plugin/Custom gRPC/BLSPowerSupplyTemplateService_server/BLSPowerSupplyTemplateService_server.lvlib"/>
			</Item>
			<Item Name="Client Wrapper APIs" Type="Folder">
				...
				<Item Name="Plug-in Specific" Type="Folder">
					<Item Name="BLSPowerSupplyTemplateService_Client_Wrapper.lvlib" Type="Library" URL="../Plugin/Custom gRPC/BLSPowerSupplyTemplateService_Client_Wrapper/BLSPowerSupplyTemplateService_Client_Wrapper.lvlib"/>
				</Item>
			</Item>
		</Item>
		...
		<Item Name="Tests" Type="Folder">
			...
			<Item Name="Test BLS Power Supply Template.vi" Type="VI" URL="../Tests/Test BLS Power Supply Template.vi"/>
			<Item Name="Test BLS Power Supply Template UI.vi" Type="VI" URL="../Tests/Test BLS Power Supply Template UI.vi"/>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Current Setpoint.lvclass" Type="LVClass" URL="../../../bls-capabilities/src/Capabilities/Low Level Capabilities/Current/Current Setpoint/Current Setpoint.lvclass"/>
			<Item Name="Setpoint.lvclass" Type="LVClass" URL="../../../bls-capabilities/src/Capabilities/Parents/Setpoint/Setpoint.lvclass"/>
			<Item Name="Voltage Setpoint.lvclass" Type="LVClass" URL="../../../bls-capabilities/src/Capabilities/Low Level Capabilities/Voltage/Voltage Setpoint/Voltage Setpoint.lvclass"/>
			<Item Name="Current Actual Value.lvclass" Type="LVClass" URL="../../../bls-capabilities/src/Capabilities/Low Level Capabilities/Current/Current Actual Value/Current Actual Value.lvclass"/>
			...
			<Item Name="Voltage Actual Value.lvclass" Type="LVClass" URL="../../../bls-capabilities/src/Capabilities/Low Level Capabilities/Voltage/Voltage Actual Value/Voltage Actual Value.lvclass"/>
			<Item Name="Error.lvclass" Type="LVClass" URL="../../../bls-capabilities/src/Capabilities/Low Level Capabilities/Error/Error.lvclass"/>
			<Item Name="Power Setpoint.lvclass" Type="LVClass" URL="../../../bls-capabilities/src/Capabilities/Low Level Capabilities/Power/Power Setpoint/Power Setpoint.lvclass"/>
			<Item Name="Power Actual Value.lvclass" Type="LVClass" URL="../../../bls-capabilities/src/Capabilities/Low Level Capabilities/Power/Power Actual Value/Power Actual Value.lvclass"/>
			<Item Name="Current Limit.lvclass" Type="LVClass" URL="../../../bls-capabilities/src/Capabilities/Low Level Capabilities/Current/Current Limit/Current Limit.lvclass"/>
			<Item Name="Limit.lvclass" Type="LVClass" URL="../../../bls-capabilities/src/Capabilities/Parents/Limit/Limit.lvclass"/>
			<Item Name="Power Limit.lvclass" Type="LVClass" URL="../../../bls-capabilities/src/Capabilities/Low Level Capabilities/Power/Power Limit/Power Limit.lvclass"/>
			...
			<Item Name="Voltage Limit.lvclass" Type="LVClass" URL="../../../bls-capabilities/src/Capabilities/Low Level Capabilities/Voltage/Voltage Limit/Voltage Limit.lvclass"/>
			<Item Name="Voltage Gradient.lvclass" Type="LVClass" URL="../../../bls-capabilities/src/Capabilities/Low Level Capabilities/Voltage/Voltage Gradient/Voltage Gradient.lvclass"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="BLS Power Supply Template" Type="Packed Library">
				...
				<Property Name="Bld_buildSpecName" Type="Str">BLS Power Supply Template</Property>
				...
				<Property Name="Destination[0].destName" Type="Str">BLS Power Supply Template.1.0.lvlibp</Property>
				<Property Name="Destination[0].path" Type="Path">/usr/lib/x86_64-linux-gnu/ni-evo-engine/plugins/BLS Power Supply Template.1.0.lvlibp</Property>
				...
				<Property Name="Source[1].itemID" Type="Ref">/RT PXI Target/BLS Power Supply Template.lvlib</Property>
				...
				<Property Name="TgtF_fileDescription" Type="Str">BLS Power Supply Template</Property>
				<Property Name="TgtF_internalName" Type="Str">BLS Power Supply Template</Property>
				<Property Name="TgtF_legalCopyright" Type="Str">Copyright © 2022 NI</Property>
				<Property Name="TgtF_productName" Type="Str">BLS Power Supply Template</Property>
				<Property Name="TgtF_targetfileGUID" Type="Str">{E1985B85-F159-441F-9EAD-7499C0C5512C}</Property>
				<Property Name="TgtF_targetfileName" Type="Str">BLS Power Supply Template.1.0.lvlibp</Property>
